...
defined('DB_USER') ? null : define("DB_USER", "your_database_user_name");
defined('DB_PASS') ? null : define("DB_PASS", "your_database_password");
defined('DB_NAME') ? null : define("DB_NAME", "your_database_name");
